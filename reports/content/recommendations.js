...
const COPY = {
  en: {
    ...
    T09: {
      ...
      action: v => `Run a root-cause review on ${v.topCritCat || 'the critical-heavy categories'} and escalate preventive measures to operations leadership.`,
    ...
    T04: {
      ...
      action: v => `Assign a site-level owner for ${v.hotspotZone} to investigate ${v.hotspotCategory} drivers and report mitigations next cycle.`,
    ...
    T03: {
      ...
      action: v => `Review operational conditions and asset age at ${v.topZoneName}; share findings with regional management.`,
  ...
  ko: {
    ...
    T09: {
      ...
      action: v => `${v.topCritCat || '중대 사안 집중 카테고리'}에 대한 근본 원인 조사와 예방 조치를 운영 리더십으로 에스컬레이션하십시오.`,
    ...
    T04: {
      ...
      action: v => `${v.hotspotZone}에 현장 책임자를 지정하여 ${v.hotspotCategory} 원인을 조사하고 다음 주기에 개선 조치를 보고하도록 하십시오.`,
    ...
    T03: {
      ...
      action: v => `${v.topZoneName}의 운영 환경과 자산 노후도를 점검하고 결과를 지역 관리자에게 공유하십시오.`,
