...
const COPY = {
  en: {
    ...
    T09: {
      ...
      action: v => `Conduct a focused review of ${v.topCritCat || 'critical-heavy categories'} and share findings with operations leadership.`,
  ...
  ko: {
    ...
    T09: {
      ...
      action: v => `${v.topCritCat || '중대 등급 집중 카테고리'}를 집중 검토하고 결과를 운영 담당자에게 공유하십시오.`,
